...
internal class FractionTest {
    ...
    @Test
    fun subtr() {
        assert(Fraction(4,6).subtract(Fraction(1,6)) == Fraction(3,6))
    }
    ...
    @Test
    fun mult() {
        assert(Fraction(2,3).mult(Fraction(1,2)) == Fraction(1,3))
    }

    @Test
    fun div() {
        assert(Fraction(1,2).div(Fraction(1,4)) == Fraction(2,1))
    }
}